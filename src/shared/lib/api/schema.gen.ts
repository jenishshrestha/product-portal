 ...
 *
 * Regenerate: bunx openapi-typescript http://localhost:3000/openapi.json -o src/shared/lib/api/schema.gen.ts
 *
 * @ts-nocheck is applied because the backend spec has known issues that
 * the generator can't work around (duplicate `getSession` operationId, etc.).
 * Importing `components["schemas"]` still works; prefer schemas over operations.
 */
...
export interface paths {
    ...
    "/api/v1/users/{id}/roles": {
        ...
        patch: {
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["UpdateUserRolesBody"];
                };
            };
            responses: {
        ...
        get: {
            parameters: {
                query?: {
                    ...
                    studyArea?: string | string[];
                    studyLevel?: string | string[];
                    qualificationType?: string | string[];
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            data: components["schemas"]["ProductFilterOptions"];
                        };
                    };
                };
                /** @description Not authenticated */
    ...
    "/api/v1/products/{id}": {
        ...
        options?: never;
        head?: never;
        /** Partial update — deep-merges into the existing document (admin only) */
        patch: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/api/v1/meta/countries": {
        ...
        /** ISO 3166-1 country list (authenticated) */
        get: {
            parameters: {
                query?: never;
                header?: never;
...
export interface components {
    schemas: {
        ...
        User: {
             ...
             *     ]
             */
            readonly roles: Record<string, never>;
        };
        UpdateUserRolesBody: {
            roles: ("user" | "admin")[];
        };
